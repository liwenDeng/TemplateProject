...
@interface DYDetailLiveViewController ()  <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation DYDetailLiveViewController
...
- (void)refreshData {
    [MSNetworking getDouyuLiveCateId:self.cateId limit:kPerloadCount offset:0 WithSuccess:^(NSDictionary *object) {
        DYRoomModelList *list = [DYRoomModelList yy_modelWithDictionary:object];
...
- (void)loadMore{
    [MSNetworking getDouyuLiveCateId:self.cateId limit:kPerloadCount offset:(self.loadCount*kPerloadCount) WithSuccess:^(NSDictionary *object) {
        DYRoomModelList *list = [DYRoomModelList yy_modelWithDictionary:object];
        if (list.error) return ;
